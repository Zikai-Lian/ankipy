...
// ── Styles ────────────────────────────────────────────────────────────────────
const S = {
  app: { minHeight: "100vh", background: "#0c0c10", color: "#e4e0d8", fontFamily: "'Source Serif 4', Georgia, serif", display: "flex", flexDirection: "column" },
  header: { borderBottom: "1px solid #252535", padding: "14px 28px", display: "flex", alignItems: "center", justifyContent: "space-between", background: "#13131c", flexWrap: "wrap", gap: "10px", position: "sticky", top: 0, zIndex: 100 },
  ...
  rb: (c) => ({ background: c, border: "none", borderRadius: "8px", padding: "11px 20px", color: "#fff", cursor: "pointer", fontSize: "13px", fontWeight: 700, fontFamily: "'Source Serif 4', Georgia, serif" }),
